...
{Fore.LIGHTCYAN_EX}    ██████╔╝ ███████╗██║    ██╔╝╚██╗
{Fore.LIGHTCYAN_EX}    ╚═════╝  ╚══════╝╚═╝    ╚═╝  ╚═╝
{Fore.LIGHTMAGENTA_EX}    ╚══════╝  TOOL SPAM DISCORD BY NGUYỄN HIẾU
{Fore.LIGHTMAGENTA_EX + Style.BRIGHT}═════════════════════════════════════════════════════
"""
    print(header)
...
{Fore.LIGHTBLUE_EX}↦ Admin : Nguyễn Hiếu
{Fore.LIGHTBLUE_EX}↦ Discord : frv_23th04
{Fore.LIGHTBLUE_EX}↦ Zalo : 0777053182
{Fore.LIGHTMAGENTA_EX + Style.BRIGHT}═════════════════════════════════════════════════════
"""
    print(author_info)

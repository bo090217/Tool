...
─────╚══╝─────────────╚══╝───────╚══╝
""", style="cyan")
    banner.append("\n🌟 TOOL ZALO TREO NGÔN BY NGUYỄN HIẾU 🌟\n", style="magenta")
...
def create_instructions_panel() -> Panel:
    ...
    instructions.append("4️⃣ Nhập tên file .txt chứa nội dung spam ngôn.\n", style="white")
...
def spam_messages_with_tag(bot, thread_id, thread_type, message_text, delay, running_flag):
    while running_flag.value:
        ...
        try:
            ...
            custom_print(f"[✅ Nguyễn Hiếu ] Đã gửi tin nhắn tới nhóm {thread_id}!", style="bold green")
...
def start_multiple_accounts():
    console.clear()
    # In banner trước
    console.print(Panel(create_main_banner(), title="Tool Treo Ngôn Nguyễn Hiếu", border_style="cyan", box=DOUBLE, width=60, padding=(0, 1)))
